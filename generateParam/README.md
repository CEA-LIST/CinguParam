...
Goal: It enables to update the database when lwe-estimator HEAD commit ID is modified. Security is estimated against primal_uSVP attack. Heuristic : Primal_uSVP is the best attack within 1 bit against parameters generated by the algorithm used in genParam.sage according to lwe-estimator. 
